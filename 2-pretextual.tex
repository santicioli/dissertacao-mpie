  	...
  	\begin{center}					% Minipage Centralizado
    	\fbox{
            ...
            \begin{minipage}[t]{11cm}	% Largura
            	...
            	\hspace{0.5cm} 
                \pageref{LastPage} p. % : il. (algumas color.) 
                ; 30 cm.\\
            	
                \hspace{0.5cm}
            	\imprimirtipotrabalho~--~Instituto Federal do Rio Grande do Sul, Programa de Metrado Profissional em Informática na Educação, Porto Alegre, RS, \imprimirdata. \hfill 
            	...
            	\hspace{0.5cm}
            		...
            		3. Institutos Federais
            		4. Jogos Sérios
            		5. Tecnologia Educacional
            		I. Miletto, Evandro Manara, orient.
                    II. Procasko, Josiane Carolina S. R., coorient. 
                    III. Título.\\
            % 		I. \imprimirtitulo \\
...
\pdfbookmark[0]{\listtablename}{los}
\input{--siglas}
\cleardoublepage
