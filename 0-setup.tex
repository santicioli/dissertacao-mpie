...
%----------------------------------------------
%crias siglas e abreviaturas
\newcommand{\siglasname}{Siglas}
\newcommand{\listofsiglasname}{Lista de Abreviaturas e Siglas}
\newfloat[chapter]{sigla}{loq}{\siglasname}
\newlistof{listofsiglas}{losa}{\listofsiglasname}
\newlistentry{siglas}{losa}{0}
\counterwithout{sigla}{chapter}
\renewcommand{\cftsiglasname}{\siglasname\space}
\renewcommand*{\cftsiglasaftersnum}{\hfill--\hfill}
%---------------------------------------------------
